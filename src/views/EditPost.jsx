...
export default function EditPost( { loggedIn, flashMessage }) {
    ...
    useEffect(() => {
        async function fetchPostData(){
            let response = await fetch(`https://kekambas-blog-api.onrender.com/api/posts/${postId}`);
                ...
                <div className="card mt-3">
                    ...
                    <div className="card-body">
                        ...
                        <div className="form-group">
                                ...
                                <textarea name="content" className="form-control my-3" defaultValue={post.content} />
                                <input type="submit" value="Edit Post" className='btn btn-success w-100' />
                                <button type="button" className="btn btn-danger w-100" data-bs-toggle="modal" data-bs-target={`#deletePostModal-${ post.id }`}>
                                    Delete
                                </button>  
                            </div>
                        </form>
